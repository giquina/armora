...
# Reset Port 3002 Script - Fixes all caching issues
echo "🔧 Resetting Port 3002 to clean state..."
...
# Step 4: Clear any port 3002 specific files
...
if [ -n "$CODESPACES" ]; then
    ...
    gh codespace ports visibility 3002:private 2>/dev/null
fi

echo "✅ Port 3002 has been reset successfully!"
