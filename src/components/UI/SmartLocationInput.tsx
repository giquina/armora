...
export function SmartLocationInput({
  ...
  const getLocationDescription = (location: string): string => {
    const descriptions: { [key: string]: string } = {
      ...
      'The Ritz London': 'Luxury hotel',
      'Claridge\'s': 'Luxury hotel',
      'The Savoy': 'Luxury hotel',
      'Park Lane Hotel': 'Premium hotel',
      'Four Seasons London': 'Luxury hotel',
      'Mandarin Oriental Hyde Park': 'Luxury hotel',
      ...
      'Knightsbridge': 'Shopping & luxury district',
