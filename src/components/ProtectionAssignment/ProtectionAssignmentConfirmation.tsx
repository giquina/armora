...
import { ProtectionLevel } from '../ProtectionAssignment/ProtectionLevelSelector';
import { VenueTimeData } from '../ProtectionAssignment/VenueTimeEstimator';
...
import styles from './ProtectionAssignmentConfirmation.module.css';

interface ProtectionAssignmentConfirmationProps {
...
export function ProtectionAssignmentConfirmation({
