...
import styles from './ProtectionAssignmentErrorBoundary.module.css';
...
interface ProtectionAssignmentErrorBoundaryState {
  hasError: boolean;
  error: Error | null;
...
interface ProtectionAssignmentErrorBoundaryProps {
  children: ReactNode;
...
export class ProtectionAssignmentErrorBoundary extends Component<ProtectionAssignmentErrorBoundaryProps, ProtectionAssignmentErrorBoundaryState> {
  private maxRetries = 3;
  
  constructor(props: ProtectionAssignmentErrorBoundaryProps) {
    super(props);
  ...
  static getDerivedStateFromError(error: Error): Partial<ProtectionAssignmentErrorBoundaryState> {
    return {
      hasError: true,
      error,
    };
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error('ProtectionAssignmentErrorBoundary caught an error:', error, errorInfo);
